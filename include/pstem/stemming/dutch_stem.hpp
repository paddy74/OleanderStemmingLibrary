...
Delete suffix e if in R1 and preceded by a non-vowel, and then undouble the
ending.

<b>Step 3a (heid):</b>

Delete heid if in R2 and not preceded by c, and treat a preceding en as in step
1(b).
...
private:
    ...
    {
        if (stem<string_typeT>::is_suffix(
                text, /*heid*/ common_lang_constants::LOWER_H,
                common_lang_constants::UPPER_H, common_lang_constants::LOWER_E,
    ...
    void step_3b(string_typeT & text)
    {
                     ...
                     common_lang_constants::UPPER_K))
        {
            ...
            m_step_2_succeeded &&
            stem<string_typeT>::delete_if_is_in_r2(
                text, /*bar*/ common_lang_constants::LOWER_B,
