...
private:
    ...
    void step_1(string_typeT & text)
    {
        if (stem<string_typeT>::delete_if_is_in_r1(
                text, /*hetenes*/ common_lang_constants::LOWER_H,
                ...
                common_lang_constants::UPPER_S, false))
        {
            return;
                     ...
                     text, /*hetene*/ common_lang_constants::LOWER_H,
                     ...
                     common_lang_constants::UPPER_E, false))
        {
            return;
                     ...
                     text, /*edes*/ common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E,
                     common_lang_constants::LOWER_D,
                     common_lang_constants::UPPER_D,
                     common_lang_constants::LOWER_E,
        ...
        if (stem<string_typeT>::is_suffix_in_r1(
                text, /*erte*/ common_lang_constants::LOWER_E,
                common_lang_constants::UPPER_E, common_lang_constants::LOWER_R,
                common_lang_constants::UPPER_R, common_lang_constants::LOWER_T,
                common_lang_constants::UPPER_T, common_lang_constants::LOWER_E,
                common_lang_constants::UPPER_E))
        {
                     ...
                     common_lang_constants::UPPER_E, false))
        {
            return;
                     ...
                     text, /*ane*/ common_lang_constants::LOWER_A,
                     common_lang_constants::UPPER_A,
                     common_lang_constants::LOWER_N,
                     common_lang_constants::UPPER_N,
                     common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E, false))
        {
            return;
                     ...
                     text, /*ede*/ common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E,
                     common_lang_constants::LOWER_D,
                     common_lang_constants::UPPER_D,
                     common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E, false))
        {
            return;
                     ...
                     text, /*ert*/ common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E,
                     common_lang_constants::LOWER_R,
                     common_lang_constants::UPPER_R,
                     common_lang_constants::LOWER_T,
                     ...
                     common_lang_constants::UPPER_S))
        {
            if (stem<string_typeT>::get_r1() <= text.length() - 1)
            {
                        ...
                        L"bcdfghjlmnoprtvyzBCDFGHJLMNOPRTVYZ"))
                {
                    ...
                    !string_util::is_one_of(
                        text[text.length() - 3], NORWEGIAN_VOWELS))
                {
                    text.erase(text.length() - 1);
                    stem<string_typeT>::update_r_sections(text);
                    return;
    ...
    void step_2(string_typeT & text)
    {
        if (stem<string_typeT>::is_suffix_in_r1(
                ...
                common_lang_constants::UPPER_D, common_lang_constants::LOWER_T,
                common_lang_constants::UPPER_T))
        {
            text.erase(text.length() - 1);
            stem<string_typeT>::update_r_sections(text);
            return;
                     ...
                     text, /*vt*/ common_lang_constants::LOWER_V,
    ...
    {
        if (stem<string_typeT>::delete_if_is_in_r1(
                text, /*hetslov*/ common_lang_constants::LOWER_H,
                common_lang_constants::UPPER_H, common_lang_constants::LOWER_E,
                common_lang_constants::UPPER_E, common_lang_constants::LOWER_T,
                common_lang_constants::UPPER_T, common_lang_constants::LOWER_S,
                common_lang_constants::UPPER_S, common_lang_constants::LOWER_L,
                common_lang_constants::UPPER_L, common_lang_constants::LOWER_O,
                common_lang_constants::UPPER_O, common_lang_constants::LOWER_V,
                common_lang_constants::UPPER_V, false))
        {
            return;
        }
        else if (stem<string_typeT>::delete_if_is_in_r1(
                     text, /*slov*/ common_lang_constants::LOWER_S,
                     common_lang_constants::UPPER_S,
                     ...
                     common_lang_constants::UPPER_V, false))
        {
            return;
                     ...
                     text, /*elov*/ common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E,
                     common_lang_constants::LOWER_L,
                     common_lang_constants::UPPER_L,
                     common_lang_constants::LOWER_O,
                     ...
                     common_lang_constants::UPPER_G, false))
        {
            return;
                     ...
                     text, /*eleg*/ common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E,
                     common_lang_constants::LOWER_L,
                     common_lang_constants::UPPER_L,
                     common_lang_constants::LOWER_E,
                     ...
                     common_lang_constants::UPPER_G, false))
        {
            return;
                     ...
                     text, /*lov*/ common_lang_constants::LOWER_L,
                     common_lang_constants::UPPER_L,
                     common_lang_constants::LOWER_O,
                     common_lang_constants::UPPER_O,
                     common_lang_constants::LOWER_V,
                     ...
                     common_lang_constants::UPPER_G, false))
        {
            return;
                     ...
                     text, /*eig*/ common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E,
                     common_lang_constants::LOWER_I,
                     common_lang_constants::UPPER_I,
                     common_lang_constants::LOWER_G,
                     common_lang_constants::UPPER_G, false))
        {
            return;
                     ...
                     text, /*leg*/ common_lang_constants::LOWER_L,
                     common_lang_constants::UPPER_L,
                     common_lang_constants::LOWER_E,
                     common_lang_constants::UPPER_E,
                     common_lang_constants::LOWER_G,
