...
static const wchar_t FRENCH_VOWELS[] = {
    ...
    0xC0, 0xCB, 0xC9, 0xCA, 0xC8, 0xCF, 0xCE, 0xD4, 0xDB, 0xD9, 0};
static const wchar_t FRENCH_ACCENTED_E[] = {0xE9, 0xE8, 0xC9, 0xC8, 0};
static const wchar_t FRENCH_AIOUES[] = {97, 105, 111, 117,  0xE8, 115, 65,
                                        73, 79,  85,  0xC8, 83,   0};

static const wchar_t GERMAN_VOWELS[] = {97,   101,  105,  111,  117, 0xFC, 121,
                                        0xE4, 0xF6, 65,   0xC4, 69,  73,   79,
                                        0xD6, 85,   0xDC, 89,   0};

static const wchar_t DANISH_VOWELS[] = {97,   101,  105,  111,  117, 121, 0xE6,
                                        0xE5, 0xF8, 65,   69,   73,  79,  85,
                                        89,   0xC6, 0xC5, 0xD8, 0};
static const wchar_t DANISH_ALPHABET[] = {
    97,  98,  99,  100, 102, 103,  104, 106, 107, 108, 109, 110,  111, 112,
    114, 116, 118, 121, 122, 0xE5, 65,  66,  67,  68,  70,  71,   72,  74,
    75,  76,  77,  78,  79,  80,   82,  84,  86,  89,  90,  0xC5, 0};

static const wchar_t FINNISH_VOWELS[] = {97,   101,  105,  111,  117, 121,
                                         0xE4, 0xF6, 65,   69,   73,  79,
                                         85,   89,   0xC4, 0xD6, 0};
static const wchar_t FINNISH_VOWELS_NO_Y[] = {
    97, 101, 105, 111, 117, 0xE4, 0xF6, 65, 69, 73, 79, 85, 0xC4, 0xD6, 0};
static const wchar_t FINNISH_VOWELS_SIMPLE[] = {97, 101, 105,  0xE4, 65,
                                                69, 73,  0xC4, 0};
static const wchar_t FINNISH_STEP_1_SUFFIX[] = {
    110, 116, 97, 101, 105, 111, 117, 121,  0xE4, 0xF6, 78,
    84,  65,  69, 73,  79,  85,  89,  0xC4, 0xD6, 0};

static const wchar_t DUTCH_VOWELS[] = {97, 101, 105, 111, 117, 121,  0xE8, 65,
                                       69, 73,  79,  85,  89,  0xC8, 0};
static const wchar_t DUTCH_KDT[] = {107, 100, 116, 75, 68, 84, 0};
static const wchar_t DUTCH_S_ENDING[] = {97,  101, 0xE8, 105, 111,  117,
                                         121, 106, 65,   69,  0xC8, 73,
                                         79,  85,  89,   74,  0};

static const wchar_t NORWEGIAN_VOWELS[] = {
    97, 101,  105, 111, 0xF8, 117,  121, 0xE5, 0xE6, 0xC5,
    65, 0xC6, 69,  73,  79,   0xD8, 85,  89,   0};
static const wchar_t PORTUGUESE_VOWELS[] = {
    97,   101,  105,  111,  117,  0xE1, 0xE9, 0xED, 0xF3,
    0xFA, 0xE2, 0xEA, 0xF4, 65,   69,   73,   79,   85,
    0xC1, 0xC9, 0xCD, 0xD3, 0xDA, 0xC2, 0xCA, 0xD4, 0};
static const wchar_t SPANISH_VOWELS[] = {
    97, 101, 105, 111, 117,  0xE1, 0xE9, 0xED, 0xF3, 0xFA, 0xFC, 65,
    69, 73,  79,  85,  0xC1, 0xC9, 0xCD, 0xD3, 0xDA, 0xDC, 0};

static const wchar_t SWEDISH_VOWELS[] = {
    97, 101, 105, 111, 117, 121,  0xE5, 0xE4, 0xF6, 65,
    69, 73,  79,  85,  89,  0xC5, 0xC4, 0xD6, 0};

static const wchar_t ITALIAN_VOWELS[] = {
    97, 101, 105, 111, 117,  0xE0, 0xE8, 0xEC, 0xF2, 0xF9, 65,
    69, 73,  79,  85,  0xC0, 0xC8, 0xCC, 0xD2, 0xD9, 0};
static const wchar_t ITALIAN_VOWELS_SIMPLE[] = {
    97, 101, 105, 111,  0xE0, 0xE8, 0xEC, 0xF2, 65,
...
protected:
    ...
    void find_french_rv(const string_typeT & text, const wchar_t * vowel_list)
    {
        ...
        if (text.length() >= 3 &&
            ((is_either<wchar_t>(
              ...
              is_either<wchar_t>(
                  text[1], common_lang_constants::LOWER_A,
                  common_lang_constants::UPPER_A) &&
              is_either<wchar_t>(
                  text[2], common_lang_constants::LOWER_R,
                  common_lang_constants::UPPER_R)) ||  // par

             (is_either<wchar_t>(
                  text[0], common_lang_constants::LOWER_C,
                  common_lang_constants::UPPER_C) &&
              is_either<wchar_t>(
                  text[1], common_lang_constants::LOWER_O,
                  common_lang_constants::UPPER_O) &&
              is_either<wchar_t>(
                  text[2], common_lang_constants::LOWER_L,
                  common_lang_constants::UPPER_L)) ||  // col

             (is_either<wchar_t>(
                  text[0], common_lang_constants::LOWER_T,
                  common_lang_constants::UPPER_T) &&
              is_either<wchar_t>(
                  text[1], common_lang_constants::LOWER_A,
                  common_lang_constants::UPPER_A) &&
              is_either<wchar_t>(
                  text[2], common_lang_constants::LOWER_P,
    ...
    void trim_western_punctuation(string_typeT & text) const
    {
        if (text.length() >= 3 && is_apostrophe(text[text.length() - 3]) &&
            is_either<wchar_t>(
                text[text.length() - 2], common_lang_constants::LOWER_S,
            ...
            is_apostrophe(text[text.length() - 1]))
        {
            ...
            text.length() >= 2 && is_apostrophe(text[text.length() - 2]) &&
            is_either<wchar_t>(
    ...
    inline bool is_suffix(
        ...
        const wchar_t suffix2U) const
    {
        if (text.length() < 2)
        {
            return false;
        }
        return is_either<wchar_t>(
                   text[text.length() - 2], suffix1L, suffix1U) &&
        ...
        const wchar_t suffix3L, const wchar_t suffix3U) const
    {
        ...
        return is_either<wchar_t>(
                   text[text.length() - 3], suffix1L, suffix1U) &&
               is_either<wchar_t>(
    ...
    inline bool is_suffix(
        const string_typeT & text, const wchar_t suffix1L,
        const wchar_t suffix1U, const wchar_t suffix2L, const wchar_t suffix2U,
        const wchar_t suffix3L, const wchar_t suffix3U, const wchar_t suffix4L,
        const wchar_t suffix4U) const
    {
        if (text.length() < 4)
        {
            return false;
        ...
        return is_either<wchar_t>(
                   text[text.length() - 4], suffix1L, suffix1U) &&
               is_either<wchar_t>(
                   text[text.length() - 3], suffix2L, suffix2U) &&
               is_either<wchar_t>(
    ...
    inline bool is_suffix(
        ...
        const wchar_t suffix1U, const wchar_t suffix2L, const wchar_t suffix2U,
        const wchar_t suffix3L, const wchar_t suffix3U, const wchar_t suffix4L,
        const wchar_t suffix4U, const wchar_t suffix5L,
        const wchar_t suffix5U) const
    {
        if (text.length() < 5)
        {
            return false;
        ...
        return is_either<wchar_t>(
                   text[text.length() - 5], suffix1L, suffix1U) &&
               is_either<wchar_t>(
                   text[text.length() - 4], suffix2L, suffix2U) &&
               is_either<wchar_t>(
                   text[text.length() - 3], suffix3L, suffix3U) &&
               is_either<wchar_t>(
        ...
        const wchar_t suffix6L, const wchar_t suffix6U) const
    {
        ...
        return is_either<wchar_t>(
                   text[text.length() - 6], suffix1L, suffix1U) &&
               is_either<wchar_t>(
                   text[text.length() - 5], suffix2L, suffix2U) &&
               is_either<wchar_t>(
                   text[text.length() - 4], suffix3L, suffix3U) &&
               is_either<wchar_t>(
                   text[text.length() - 3], suffix4L, suffix4U) &&
               is_either<wchar_t>(
    ...
    inline bool is_suffix(
        ...
        const wchar_t suffix3L, const wchar_t suffix3U, const wchar_t suffix4L,
        const wchar_t suffix4U, const wchar_t suffix5L, const wchar_t suffix5U,
        const wchar_t suffix6L, const wchar_t suffix6U, const wchar_t suffix7L,
        const wchar_t suffix7U) const
    {
        if (text.length() < 7)
        {
            return false;
        ...
        return is_either<wchar_t>(
                   text[text.length() - 7], suffix1L, suffix1U) &&
               is_either<wchar_t>(
                   text[text.length() - 6], suffix2L, suffix2U) &&
               is_either<wchar_t>(
                   text[text.length() - 5], suffix3L, suffix3U) &&
               is_either<wchar_t>(
                   text[text.length() - 4], suffix4L, suffix4U) &&
               is_either<wchar_t>(
                   text[text.length() - 3], suffix5L, suffix5U) &&
               is_either<wchar_t>(
    ...
    inline bool is_suffix(
        ...
        const wchar_t suffix4U, const wchar_t suffix5L, const wchar_t suffix5U,
        const wchar_t suffix6L, const wchar_t suffix6U, const wchar_t suffix7L,
        const wchar_t suffix7U, const wchar_t suffix8L,
        const wchar_t suffix8U) const
    {
        if (text.length() < 8)
        {
            return false;
        ...
        return is_either<wchar_t>(
                   text[text.length() - 8], suffix1L, suffix1U) &&
               is_either<wchar_t>(
                   text[text.length() - 7], suffix2L, suffix2U) &&
               is_either<wchar_t>(
                   text[text.length() - 6], suffix3L, suffix3U) &&
               is_either<wchar_t>(
                   text[text.length() - 5], suffix4L, suffix4U) &&
               is_either<wchar_t>(
                   text[text.length() - 4], suffix5L, suffix5U) &&
               is_either<wchar_t>(
                   text[text.length() - 3], suffix6L, suffix6U) &&
               is_either<wchar_t>(
    ...
    inline bool is_suffix(
        ...
        const wchar_t suffix4U, const wchar_t suffix5L, const wchar_t suffix5U,
        const wchar_t suffix6L, const wchar_t suffix6U, const wchar_t suffix7L,
        const wchar_t suffix7U, const wchar_t suffix8L, const wchar_t suffix8U,
        const wchar_t suffix9L, const wchar_t suffix9U) const
    {
        ...
        return is_either<wchar_t>(
                   text[text.length() - 9], suffix1L, suffix1U) &&
               is_either<wchar_t>(
                   text[text.length() - 8], suffix2L, suffix2U) &&
               is_either<wchar_t>(
                   text[text.length() - 7], suffix3L, suffix3U) &&
               is_either<wchar_t>(
                   text[text.length() - 6], suffix4L, suffix4U) &&
               is_either<wchar_t>(
                   text[text.length() - 5], suffix5L, suffix5U) &&
               is_either<wchar_t>(
                   text[text.length() - 4], suffix6L, suffix6U) &&
               is_either<wchar_t>(
                   text[text.length() - 3], suffix7L, suffix7U) &&
               is_either<wchar_t>(
                   text[text.length() - 2], suffix8L, suffix8U) &&
        ...
        const wchar_t suffix2U)
    {
        ...
        return (
            is_either<wchar_t>(text[start_index], suffix1L, suffix1U) &&
    ...
    inline bool is_partial_suffix(
        const string_typeT & text, const size_t start_index,
        const wchar_t suffix1L, const wchar_t suffix1U, const wchar_t suffix2L,
        const wchar_t suffix2U, const wchar_t suffix3L, const wchar_t suffix3U)
    {
        ...
        const wchar_t suffix1U, const wchar_t suffix2L, const wchar_t suffix2U)
    {
        ...
        return (
            (is_either<wchar_t>(text[text.length() - 2], suffix1L, suffix1U) &&
             is_either<wchar_t>(
        ...
        const wchar_t suffix3L, const wchar_t suffix3U)
    {
        ...
        return (
            (is_either<wchar_t>(text[text.length() - 3], suffix1L, suffix1U) &&
        ...
        const wchar_t suffix4U)
    {
        ...
        return (
            (is_either<wchar_t>(text[text.length() - 4], suffix1L, suffix1U) &&
        ...
        const wchar_t suffix4U, const wchar_t suffix5L, const wchar_t suffix5U)
    {
        ...
        return (
            (is_either<wchar_t>(text[text.length() - 5], suffix1L, suffix1U) &&
        ...
        const wchar_t suffix6L, const wchar_t suffix6U)
    {
        ...
        return (
            (is_either<wchar_t>(text[text.length() - 6], suffix1L, suffix1U) &&
        ...
        const wchar_t suffix7U)
    {
        ...
        return (
            (is_either<wchar_t>(text[text.length() - 7], suffix1L, suffix1U) &&
        ...
        const wchar_t suffix7U, const wchar_t suffix8L, const wchar_t suffix8U)
    {
        ...
        return (
            (is_either<wchar_t>(text[text.length() - 8], suffix1L, suffix1U) &&
             ...
             is_either<wchar_t>(
                 text[text.length() - 1], suffix8L, suffix8U)) &&
    ...
    inline bool is_suffix_in_r2(
        ...
        const wchar_t suffix3U, const wchar_t suffix4L, const wchar_t suffix4U,
        const wchar_t suffix5L, const wchar_t suffix5U, const wchar_t suffix6L,
        const wchar_t suffix6U)
    {
        if (text.length() < 6)
        {
            return false;
    ...
    inline bool delete_if_is_in_r1(
        string_typeT & text, const wchar_t suffix1L, const wchar_t suffix1U,
        const wchar_t suffix2L, const wchar_t suffix2U, const wchar_t suffix3L,
        const wchar_t suffix3U, const bool success_on_find = true)
    {
        if (text.length() < 3)
        {
            return false;
    ...
    inline bool delete_if_is_in_r1(
        ...
        const wchar_t suffix3U, const wchar_t suffix4L, const wchar_t suffix4U,
        const wchar_t suffix5L, const wchar_t suffix5U, const wchar_t suffix6L,
        const wchar_t suffix6U, const bool success_on_find = true)
    {
        if (text.length() < 6)
        {
            return false;
    ...
    inline bool delete_if_is_in_r1(
        ...
        const wchar_t suffix3U, const wchar_t suffix4L, const wchar_t suffix4U,
        const wchar_t suffix5L, const wchar_t suffix5U, const wchar_t suffix6L,
        const wchar_t suffix6U, const wchar_t suffix7L, const wchar_t suffix7U,
        const bool success_on_find = true)
    {
        if (text.length() < 7)
        {
    ...
    void hash_dutch_yi(string_typeT & text, const wchar_t * vowel_string)
    {
        ...
        {
            if (in_vowel_block && text[i] == common_lang_constants::LOWER_I &&
                string_util::is_one_of(text[i + 1], vowel_string))
            {
                ...
                in_vowel_block && text[i] == common_lang_constants::UPPER_I &&
                string_util::is_one_of(text[i + 1], vowel_string))
            {
                text[i] = UPPER_I_HASH;
                in_vowel_block = false;
                ...
                in_vowel_block && text[i] == common_lang_constants::LOWER_Y)
            {
                ...
                in_vowel_block && text[i] == common_lang_constants::UPPER_Y)
            {
                text[i] = UPPER_Y_HASH;
                in_vowel_block = false;
            }
        ...
        if (in_vowel_block && text[i] == common_lang_constants::LOWER_Y)
        {
            text[i] = LOWER_Y_HASH;
            in_vowel_block = false;
        }
        else if (in_vowel_block && text[i] == common_lang_constants::UPPER_Y)
        {
            text[i] = UPPER_Y_HASH;
            in_vowel_block = false;
        }
    ...
    inline void unhash_dutch_yi(string_typeT & text)
    {
        string_util::replace_all<wchar_t, string_typeT>(
            text, LOWER_Y_HASH, common_lang_constants::LOWER_Y);
        string_util::replace_all<wchar_t, string_typeT>(
            text, UPPER_Y_HASH, common_lang_constants::UPPER_Y);
        string_util::replace_all<wchar_t, string_typeT>(
            text, LOWER_I_HASH, common_lang_constants::LOWER_I);
        string_util::replace_all<wchar_t, string_typeT>(
    ...
    void hash_german_yu(string_typeT & text, const wchar_t * vowel_string)
    {
        ...
        // hashable values must be between vowels, so don't bother looking at
        // last letter
    }
    ...
    inline void unhash_german_yu(string_typeT & text)
    {
        ...
        string_util::replace_all<wchar_t, string_typeT>(
            text, UPPER_Y_HASH, common_lang_constants::UPPER_Y);
        string_util::replace_all<wchar_t, string_typeT>(
            text, LOWER_U_HASH, common_lang_constants::LOWER_U);
        string_util::replace_all<wchar_t, string_typeT>(
    ...
    void hash_french_yui(string_typeT & text, const wchar_t * vowel_string)
    {
        ...
        for (i = 0; i < text.length() - 1; ++i)
        {
            ...
            // If just following letter is a vowel then examine for 'y'
                ...
                string_util::is_one_of(text[i + 1], vowel_string) &&
                is_neither<wchar_t>(
                    text[i + 1], common_lang_constants::LOWER_Y,
            ...
            else if (string_util::is_one_of(text[i], vowel_string))
            {
                        ...
                        common_lang_constants::UPPER_Q))
                {
                    ...
                    text[i] == common_lang_constants::UPPER_U && (i > 0) &&
                    is_either<wchar_t>(
                        text[i - 1], common_lang_constants::LOWER_Q,
                        common_lang_constants::UPPER_Q))
                {
            ...
            string_util::is_one_of(text[i - 1], vowel_string))
        {
            ...
            text[i] == common_lang_constants::UPPER_Y && (i > 0) &&
            string_util::is_one_of(text[i - 1], vowel_string))
        {
            text[i] = UPPER_Y_HASH;
        }
        else if (
            text[i] == common_lang_constants::LOWER_U && (i > 0) &&
            is_either<wchar_t>(
                text[i - 1], common_lang_constants::LOWER_Q,
                common_lang_constants::UPPER_Q))
        {
    ...
    inline size_t get_r1() const { return m_r1; }
    inline void set_r1(const size_t val) { m_r1 = val; }

    inline size_t get_r2() const { return m_r2; }
    inline void set_r2(const size_t val) { m_r2 = val; }

    inline size_t get_rv() const { return m_rv; }
    inline void set_rv(const size_t val) { m_rv = val; }

    void reset_r_values() { m_r1 = m_r2 = m_rv = 0; }
